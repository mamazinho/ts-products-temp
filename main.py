...
class Main:
    ...
    def read_product_by_name(self):
        products = ProductController().read_by_name('Test Prod')
        for prod in products:
            print(prod)
        print("Produto Lido")

    def read_product_by_gtin(self):
        products = ProductController().read_by_gtin('test gtin updated')
        for prod in products:
            print(prod)
        print("Produto Lido")

    def read_product_by_seller_id(self):
        products = ProductController().read_by_seller_id(self.seller_id)
        for prod in products:
            print(prod)
        print("Produto Lido")
